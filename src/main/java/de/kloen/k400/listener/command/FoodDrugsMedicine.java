    ...
    public void onMessageReceived(MessageReceivedEvent event) {
        ...
        if (isCommand(eventMessage)) {
            if (isExpectedCommand(eventMessage, STIM_PACK)) {
                ...
                commandService.executeCommand(event, author, userName, STIM_PACK_KARMA, message);
                ...
                commandService.executeCommand(event, author, userName, JET_KARMA, message);
                ...
                commandService.executeCommand(event, author, userName, FEV_KARMA, message);
                ...
                commandService.executeCommand(event, author, userName, SERUM_KARMA, message);
                ...
                commandService.executeCommand(event, author, userName, MENTATS_KARMA, message);
                ...
                commandService.executeCommand(event, author, userName, BUFFOUT_KARMA, message);
                ...
                commandService.executeCommand(event, author, userName, RADAWAY_KARMA, message);
                ...
                commandService.executeCommand(event, author, userName, SUGARBOMBS_KARMA, message);
                ...
                commandService.executeCommand(event, author, userName, NUKA_KARMA, message);
            }
